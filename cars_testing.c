...
void *car_cross(void *arg) {
    ...
    while(1){
	    ...
	    //printf("%d %d %d\n",first_car_in_line->in_dir, first_car_in_line->out_dir, first_car_in_line->id);
            char *In_dir=malloc(sizeof(char)*6);
	    char *Out_dir=malloc(sizeof(char)*6);
            switch(first_car_in_line->in_dir){
                   case NORTH:
                   strcpy(In_dir,"north");
                   In_dir[5]='\0';
                   break;
            ...
            switch(first_car_in_line->out_dir){
                   case NORTH:
                   strcpy(Out_dir,"north");
                   Out_dir[5]='\0';
                   break;
 
                   case SOUTH:
                   strcpy(Out_dir,"south");
                   Out_dir[5]='\0';
                   break;
            ...
            printf("car %d goes from %s to %s\n",first_car_in_line->id, In_dir, Out_dir);
